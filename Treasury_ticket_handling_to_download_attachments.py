...
# General log file
log_file = os.path.join(log_dir, f'treasury_general_{timestamp}.log')
# Error log file
error_log_file = os.path.join(log_dir, f'treasury_error_{timestamp}.log')
...
def download_all_attachments_and_pdfs(json_file, headers):
    ...
    for ticket in tickets:
        ...
        if not sys_id:
            ...
            log_error_to_file("❌ Skipping ticket with missing sys_id")
            continue
